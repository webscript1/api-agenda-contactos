...
const validator = new validatorUser_1.default();
const router = express_1.default.Router();
router.get('/test', usuario_1.default.test);
router.post('/create', validator.createUser, usuario_1.default.create);
router.get('/get/:id', usuario_1.default.get);
router.get('/get-all', sesion_1.default, usuario_1.default.getAll); //admin
router.put('/update/:id', validator.update, sesion_1.default, usuario_1.default.update);
...
router.post('/sing-in', validator.singIn, usuario_1.default.singIn);
